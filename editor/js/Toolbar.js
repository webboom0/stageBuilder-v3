...
function Toolbar( editor ) {
	...
	const rotateIcon = createSvgIcon( rotateSvg, strings.getKey( 'toolbar/rotate' ) );

	const rotate = new UIButton();
	rotate.dom.className = 'Button toolbar-btn';
	rotate.dom.title = strings.getKey( 'toolbar/rotate' );
	...
	const scaleIcon = createSvgIcon( scaleSvg, strings.getKey( 'toolbar/scale' ) );

	const scale = new UIButton();
	scale.dom.className = 'Button toolbar-btn';
	scale.dom.title = strings.getKey( 'toolbar/scale' );
